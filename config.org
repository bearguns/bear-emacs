...
I'm working. More than that, I don't want to install more packages
than I need. Emacs ships with a handful of color themes. Some are
light, some dark. Some are very nice and easy to look at, some make
you want to burn your eyes out with a hot, rusty fork. But, using a
built-in theme cuts down on configuration items to manage, and helps
remind me that the point of this great editor is to you know.../edit
stuff/.
#+BEGIN_SRC emacs-lisp
