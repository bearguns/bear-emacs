...
*** Eglot
[[https://github.com/joaotavora/eglot][Eglot]] is an excellent package for interacting with the (also
excellent) [[https://langserver.org/][Language Server Protocol]], which powers IDE-like features in
a growing number of editors. This block will make sure Eglot is
installed, and configure it to work with the appropriate server for
the different languages in which I regularly program.
