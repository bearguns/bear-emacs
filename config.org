...
I work with JIRA/Confluence at work, and I want to be able to author
Atlassian markup in org-mode. I need to make sure I have [[https://github.com/emacsmirror/org/blob/master/contrib/lisp/ox-confluence.el][ox-confluence]]
in my load path so it can be =require=d below.
#+BEGIN_SRC emacs-lisp
